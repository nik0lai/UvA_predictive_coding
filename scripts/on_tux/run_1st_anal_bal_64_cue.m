...
%% 01. Classify cue in EXPECTATION condition (no response was given)
...
cfg.outputdir = '/home/nicolas1/Documents/predictive_eeg/MVPA_RESULTS/EXPECTATION/CUE_PRED_bal_64hz';
adam_MVPA_firstlevel(cfg);

%% 02. Classify cue in RELEVANCE TASK condition (no response was given)
...
cfg.outputdir = '/home/nicolas1/Documents/predictive_eeg/MVPA_RESULTS/TASKRELEVANCE/CAT_PRED_bal_64hz';
adam_MVPA_firstlevel(cfg);
