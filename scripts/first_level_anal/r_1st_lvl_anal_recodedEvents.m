...
%%
cfg = [];
cfg.datadir            = '/home/nicolas1/Documents/predictive_eeg/EEGLAB_DATA/recoded_events'; % put the actual source directory here
...
%% 01. Classify corectly predicted stim in EXPECTATION session
